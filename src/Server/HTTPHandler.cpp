        ...
        if (settings.http_write_exception_in_output_format && current_output_format.supportsWritingException())
        {
            ...
            if (buffer_until_eof)
            {
                ...
                used_output.exception_writer = [&, format_name, header, context_, format_settings](WriteBuffer & buf, int code, const String & message)
                {
                    ...
                    setHTTPResponseStatusAndHeadersForException_A(code, request, response, used_output.out_holder.get());
            ...
            else
            {
                ...
                setHTTPResponseStatusAndHeadersForException_A(status.code, request, response, used_output.out_holder.get());
